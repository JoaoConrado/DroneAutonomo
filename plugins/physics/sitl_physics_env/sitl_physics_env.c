...
void webots_physics_init() {
  ...
  vehicleID = dWebotsGetBodyFromDEF("DRONE");
  if (vehicleID == NULL)
  {
     dWebotsConsolePrintf("WARNING: NO DRONE OBJECT TO CONTROL no wind calculations will be applied.\n");
     return ;
  }
  else
  {
    dWebotsConsolePrintf("DRONE object found.\n");
